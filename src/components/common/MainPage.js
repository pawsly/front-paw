...
const Main = () => {
  ...
  const [boardList, setBoardList] = useState([
    { title: "친환경 제품을 사용한 기업 제품 소개" },
    { title: "티 추천 top 5" },
    { title: "실내 조명의 역할" },
    { title: "싱그러움을 가득 머금은 카페 정원" },
    { title: "모르면 후회하는 친환경 실내디자인..." },
  ]);
  // useEffect(() => {
  //   axios
  //     .get("http://3.39.25.7:8080/board/list")
  //     .then((response) => {
